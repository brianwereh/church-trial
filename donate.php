        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">JUDAH FIRST</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 28th Jan, 2024</span>
                  <span><i class="fa fa-archive"></i> <a href="#">Bethel PC Sanctuary</a>, <a href="#">Nairobi</a></span>
                </span>
                	...
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                      	  ...
                      	  <li class="list-group-item"> <span class="badge">#</span> Amount Needed </li>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, please call #.785.876</p>
                  </div>
                </div>
              </div>
            </div>
